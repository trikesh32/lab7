...
import client.utils.ScriptRecursionException;
...
public class ScriptExecutor {
    ...
    private ExitCode launchCommand(String[] userCommand) {
        ...
        switch (userCommand[0]) {
            ...
            case "remove_lower" -> mainController.removeLower();
            case "sum_of_capacity" -> mainController.sumOfCapacity();
            case "filter_by_capacity" -> mainController.filterByCapacity();
            case "filter_less_than_type" -> mainController.filterLessThanType();
