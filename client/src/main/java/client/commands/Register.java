...
public class Register extends Command{
    ...
    public Register(UDPClient client, Console console){
        super("reg", "Проводит регистрацию");
        this.client = client;
    ...
    public ExecutionResponse apply(String[] args) {
        try {
            ...
            if (response.getExitCode()){
                ...
                return new ExecutionResponse("Пользователь " + response.getUser().getName() + " зарегистрирован");
            }
